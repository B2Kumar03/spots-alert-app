...
function PlaceDetails() {
  ...
  return (
    <div className="p-4 space-y-4 border-t border-gray-300 mt-2">
      ...
      <p className="text-gray-700"><strong>Distance:</strong> {distance} km</p>
      ...
      {/* Map UI */}
      <div className="h-[400px] w-full relative rounded overflow-hidden shadow border">
        <MapContainer
          center={[lat, lon]}
          zoom={15}
